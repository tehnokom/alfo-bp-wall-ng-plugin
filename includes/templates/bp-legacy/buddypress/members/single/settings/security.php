...
<h2 class="bp-screen-reader-text"><?php
	...
	_e( 'Wall security settings', 'bp-wall' );
?></h2>
...
<fieldset class="wall-security">
	<h4><legend><?php _e( 'Wall Post Security', 'bp-wall' ); ?></legend></h4>

	<p><?php _e( 'Who can post to member\'s wall?', 'bp-wall' ); ?></p>
	...
	<div class="checkbox">
		...
		<label for="member-post-wall-security-fof"><input type="checkbox" name="member-post-wall-security-fof" id="member-post-wall-security-fof" value="fof"<?php bp_wall_member_show_wall_security_setting( 'fof' ); ?> /> <?php _e( 'Friends of friends', 'bp-wall' ); ?></label>

		<label for="member-post-wall-security-everyone"><input type="checkbox" name="member-post-wall-security-everyone" id="member-post-wall-security-everyone" value="everyone"<?php bp_wall_member_show_wall_security_setting( 'everyone' ); ?> /> <?php _e( 'Everyone', 'bp-wall' ); ?></label>
...
<fieldset class="wall-comment-security">
	<h4><legend><?php _e( 'Wall Comment Security', 'bp-wall' ); ?></legend></h4>

	<p><?php _e( 'Who can comment member\'s wall posts?', 'bp-wall' ); ?></p>
	...
	<div class="checkbox">
		...
		<label for="member-comment-wall-security-fof"><input type="checkbox" name="member-comment-wall-security-fof" id="member-comment-wall-security-fof" value="fof"<?php bp_wall_member_show_wall_comment_security_setting( 'fof' ); ?> /> <?php _e( 'Friends of friends', 'bp-wall' ); ?></label>

		<label for="member-comment-wall-security-everyone"><input type="checkbox" name="member-comment-wall-security-everyone" id="member-comment-wall-security-everyone" value="everyone"<?php bp_wall_member_show_wall_comment_security_setting( 'everyone' ); ?> /> <?php _e( 'Everyone', 'bp-wall' ); ?></label>
