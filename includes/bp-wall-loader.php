...
class BP_Wall {
	...
	function get_wall_activities( $page = 0, $per_page = 20 ){
		...
		$where_conditions['activity_sql'] = "( $table_activity.user_id = $user_id AND $table_activity.type!='activity_comment' AND $table_activity.component!='groups' AND $table_activity.component!='friends') OR ($table_activity.type='activity_update' AND $table_activity.item_id = $user_id ) ";
